...
export const travelDeck: Card[] = [
  ...
  { id: 'travel-04', text: 'Advance to Paris.', effect: { type: 'move-to', tileIndex: 42 } },
...
export const customsDeck: Card[] = [
  ...
  { id: 'customs-06', text: 'Advance to Lisbon Airport.', effect: { type: 'move-to', tileIndex: 6 } },
  ...
  { id: 'customs-12', text: 'Advance to Rome.', effect: { type: 'move-to', tileIndex: 32 } },
